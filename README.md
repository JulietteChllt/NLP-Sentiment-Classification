...
⚠️ In order to do transfer learning with the same data set please consider downloading the data set from [AIcrowd](https://www.aicrowd.com/challenges/epfl-ml-text-classification/dataset_files) and add it to Ressources directory.
